            ...
            <div class="modal-body">
                ...
                <div class="callout callout-warning">
                  <b><?php _e('Советы по модерации'); ?></b><br>
                     <?php _e('1. Проверьте совпадает ли тематика сайта с той которую указал вебмастер. Если не совпадает, вы можете указать подходящую тематику в выпадающем списке.'); ?><br>
