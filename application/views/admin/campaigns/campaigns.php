...
<html>
    <head>
        ...
        <title><?php echo get_globalsettings('custom_name', 'AdFlex')?> > <?php _e('Кампании'); ?> > <?php _e('Кабинет админиcтратора'); ?></title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        ...
                        <button data-target="#add-camp" data-toggle="modal" data-backdrop="static" data-keyboard="false" class="btn btn-danger btn-sm">
                    ...
                    <?php if ($filter_username): ?>
                        <div class="filter-box">
                            ...
                            <div class="filter-item">
                                ...
                                <a href="/administrator/campaigns/" class="close"><span>×</span></a>
                            </div>
                        </div>
                    <?php endif; ?>
