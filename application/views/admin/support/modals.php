            ...
            <div class="modal-body" style="padding:0; border-bottom: 1px solid #F4F4F4;">
                ...
                <div class="direct-chat-messages" style="max-height: 350px; height: auto; padding: 10px 15px;">
                    ...
                    <div v-for="message in messages">
                        ...
                        <div v-if="message.role == 'administrator'" class="direct-chat-msg right">
                            ...
                            <div class="direct-chat-text direct-chat-text-red" v-html="message.message"></div>
                        </div>


                        <div v-else-if="message.subrole == 'moderator'" class="direct-chat-msg">
                            <div class="direct-chat-info clearfix">
                            ...
                            <div class="direct-chat-text left-direct-chat-text-purple" v-html="message.message"></div>
                        </div>
