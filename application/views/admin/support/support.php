...
<html>
    <head>
        ...
        <title><?php echo get_globalsettings('custom_name', 'AdFlex')?> > <?php _e('Поддержка'); ?> > <?php _e('Кабинет админиcтратора'); ?></title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1><?php _e('Поддержка'); ?>
                        <button class="btn btn-danger btn-sm" data-target="#add-ticket" data-toggle="modal">
                    ...
                    <ol class="breadcrumb">
                        <li class="active"><a href="/administrator/dashboard"><i class="fa fa-dashboard"></i> <?php _e('Консоль'); ?></a></li>
                    ...
                    <?php if ($filter_username): ?>
                        <div class="filter-box">
                            ...
                            <div class="filter-item">
                                ...
                                <a href="/administrator/support/" class="close"><span>×</span></a>
                            </div>
                        </div>
                    <?php endif; ?>
