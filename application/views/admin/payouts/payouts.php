...
<html>
    <head>
        ...
        <title><?php echo get_globalsettings('custom_name', 'AdFlex')?> > <?php _e('Выплаты'); ?> > <?php _e('Кабинет админиcтратора'); ?></title>
                    ...
                    <?php if ($filter_username): ?>
                        <div class="filter-box">
                            ...
                            <div class="filter-item">
                                ...
                                <a href="/administrator/payouts/" class="close"><span>×</span></a>
                            </div>
                        </div>
                    <?php endif; ?>
