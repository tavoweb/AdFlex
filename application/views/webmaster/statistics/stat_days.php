...
<html>
    <head>
        ...
        <title><?php echo get_globalsettings('custom_name', 'AdFlex')?> > <?php _e('Статистика по дням'); ?> > <?php _e('Кабинет вебмастера'); ?></title>
                ...
                <section class="content">
                    ...
                    <div class="row" style="margin-bottom: 15px;">
                        <div class="col-md-12">
                            ...
                            <div class="btn-group">
                                <a href="/webmaster/statistics/days" class="btn btn-primary"><?php _e('По дням') ?></a>
