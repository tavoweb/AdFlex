...
<html>
    <head>
        ...
        <title><?php echo get_globalsettings('custom_name', 'AdFlex')?> > <?php _e('Статистика по сайтам'); ?> > <?php _e('Кабинет вебмастера'); ?></title>
                    ...
                    <div class="row" style="margin-bottom: 15px;">
                        <div class="col-md-12">
                            ...
                            <div class="btn-group">
                                ...
                                <a href="/webmaster/statistics/sites" class="btn btn-primary"><?php _e('По сайтам') ?></a>
                                <a href="/webmaster/statistics/units" class="btn btn-default"><?php _e('По блокам') ?></a>
                            </div>
