...
<script id="site-adunit-manage" type="text/html">
    <a href="/webmaster/units/{%=o.site_id%}" class="btn btn-sm btn-default"> <i class="fa fa-th-large"></i> <?php _e('Рекламные блоки'); ?> [{%=o.count_units%}]</a>
</script>
...
<script id="site-actions" type="text/html">
    <div class="btn-group">
        ...
        <ul class="dropdown-menu pull-right" role="menu">
            ...
            <li>
                <a href="/webmaster/statistics/units?site_id={%=o.site_id%}">
                    <i class="fa fa-line-chart"></i> <?php _e('Статистика'); ?>
                </a>
            </li>
            <li class="divider"></li>
            <li class="site-action" data-id="{%=o.site_id%}" data-action="delete">
                <a href="javascript:void(0);">
