...
<html>
    <head>
        ...
        <title><?php echo get_globalsettings('custom_name', 'AdFlex')?> > <?php _e('Статистика по обьявлениям'); ?> > <?php _e('Кабинет рекламодателя'); ?></title>
                ...
                <section class="content">
                    ...
                    <div class="row" style="margin-bottom: 15px;">
                        <div class="col-md-12">
                            ...
                            <div class="btn-group">
                                <a href="/advertiser/statistics/days" class="btn btn-default"><?php _e('По дням') ?></a>
                                <a href="/advertiser/statistics/camps" class="btn btn-default"><?php _e('По кампаниям') ?></a>
                                <a href="/advertiser/statistics/ads" class="btn btn-success"><?php _e('По обьявлениям') ?></a>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="filter-box">
                                    ...
                                    <div class="filter-item" style="background: #00A65A;">
                                        <i class="fa fa-fw fa-filter"></i>
                                        <?php echo htmlspecialchars($camp_name); ?>
                                        <a href="/advertiser/statistics/ads" class="close"><span>×</span></a>
                                    </div>
                                </div>
