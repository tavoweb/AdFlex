...
<html>
    <head>
        ...
        <title><?php echo get_globalsettings('custom_name', 'AdFlex')?> > <?php _e('Статистика по кампаниям'); ?> > <?php _e('Кабинет рекламодателя'); ?></title>
                    ...
                    <div class="row" style="margin-bottom: 15px;">
                        <div class="col-md-12">
                            ...
                            <div class="btn-group">
                                ...
                                <a href="/advertiser/statistics/camps" class="btn btn-success"><?php _e('По кампаниям') ?></a>
