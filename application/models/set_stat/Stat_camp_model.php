...
class Stat_camp_model extends CI_Model {
    ...
    public function __construct()
    {
        ...
        $this->table = config_item('stat_camps_table');
    }
    ...
    public function set_view($unit_obj, $ads_obj)
    {
        foreach ($ads_obj as $ad_obj) {
            $this->set_camp_view($ad_obj);
        }
    }


    public function set_camp_view($ad_obj)
    {
        $camp_obj = $ad_obj->camp();
